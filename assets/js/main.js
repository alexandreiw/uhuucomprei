...
function scrollWhatsApp() {
  const scrollWhatsApp = document.getElementById('whatsapp');
  // When the scroll is higher than 2000 viewport height, add the show-scroll class to the a tag with the scroll-top class
  if (this.scrollY >= 2000) {
    scrollWhatsApp.classList.add('show-whatsapp');
  } else {
    scrollWhatsApp.classList.remove('show-whatsapp');
  }
}
window.addEventListener('scroll', scrollWhatsApp);
